        ...
        children: [
          if (isLoading)
            const LoadingCard(
              ...
              subtitle:
                  'Running dart analyze and scanning for deprecated APIs...',
            )
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Analysis Results',
                      style: Theme.of(context).textTheme.headlineSmall),
                  const SizedBox(height: 16),
                  if (pipeline.analysisResults!.isEmpty)
                    Row(
  ...
  Widget build(BuildContext context) {
    return const SectionPage(
      ...
      child: LoadingCard(
        ...
        subtitle: 'Creating per-file diffs for your project...',
      ),
    );
  }
}
